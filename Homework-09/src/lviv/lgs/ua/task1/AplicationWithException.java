...
public class AplicationWithException {
	...
	public static void main(String[] args) throws WrongInputConsoleParametersException {
		...
		while (true) {
			...
			case "1": { //¬вед≥ть 1, щоб перев≥рити чи Ї такий м≥с€ць
			...
			case "2": { //¬вед≥ть 2, щоб вивести вс≥ м≥с€ц≥ з такою ж порою року
			...
			case "3": { //¬вед≥ть 3, щоб вивести вс≥ м≥с€ц≥ €к≥ мають таку саму к≥льк≥сть дн≥в
				System.out.println("Please enter a month: ");
				str = scanner.nextLine();
			...
			case "4": { //¬вед≥ть 4, щоб вивести на екран вс≥ м≥с€ц≥ €к≥ мають меншу к≥льк≥сть дн≥в
				System.out.println("Please enter a month: ");
				str = scanner.nextLine();
			...
			case "5": { //¬вед≥ть 5, щоб вивести на екран вс≥ м≥с€ц≥ €к≥ мають б≥льшу к≥льк≥сть дн≥в
				System.out.println("Please enter a month: ");
				str = scanner.nextLine();
			...
			case "6": { //¬вед≥ть 6, щоб вивести на екран наступну пору року
				System.out.println("Please enter a month: ");
				str = scanner.nextLine();
			...
			case "7": { //¬вед≥ть 7, щоб вивести на екран попередню пору року
				System.out.println("Please enter a season: ");
				str = scanner.nextLine();
			...
			case "8": { //¬вед≥ть 8, щоб вивести на екран вс≥ м≥с€ц≥ €к≥ мають парну к≥льк≥сть дн≥в
			...
			case "9": { //¬вед≥ть 9, щоб вивести на екран вс≥ м≥с€ц≥ €к≥ мають непарну к≥льк≥сть дн≥в
				for (Months month : months) {
					if (month.getDay() % 2 != 0)
						System.out.println(month);
			...
			case "10": { //¬вед≥ть 10, щоб вивести на екран чи введений з консол≥ м≥с€ць маЇ парну к≥льк≥сть дн≥в
				System.out.println("Please enter a month: ");
				str = scanner.nextLine();
